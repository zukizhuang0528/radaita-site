import svgPaths from "./svg-0r2fukkmcx";
import imgCanvas from "figma:asset/86b3fda691f59b46f91144ad58313da64ae0ea7e.png";
import imgHeader from "figma:asset/3fa90a516c4518e4045f9629317274a8f5566d02.png";
      ...
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon">
          ...
          <g id="tabler-icon-database">
            <path d={svgPaths.p2ead5280} id="Vector" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px not-italic relative">
      <p className="font-['Poppins:Bold',sans-serif] relative shrink-0 text-[16px] text-white w-full">Data Collection</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#9ca3af] text-[12px] w-full">Custom data collection across text, image, audio, and video for real-world AI workflows.</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[48px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon">
          ...
          <path d={svgPaths.p3c892c00} id="Vector 1" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeWidth="2" />
          <path d={svgPaths.p28c18580} id="Vector 2" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeWidth="2" />
          <g id="tabler-icon-tag">
            <g id="Vector">
              <path d={svgPaths.p111c1e80} stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
              <path d={svgPaths.p383f8b30} stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </g>
          </g>
        </g>
      </svg>
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px not-italic relative">
      <p className="font-['Poppins:Bold',sans-serif] relative shrink-0 text-[16px] text-white w-full">Data Annotation</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#9ca3af] text-[12px] w-full">High-quality annotation workflows for text, image, audio, video, and multimodal AI systems.</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[48px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon">
          ...
          <path d={svgPaths.p3c892c00} id="Vector 1" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeWidth="2" />
          <path d={svgPaths.p28c18580} id="Vector 2" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeWidth="2" />
          <g id="tabler-icon-cpu">
            <path d={svgPaths.p17790980} id="Vector" stroke="var(--stroke-0, #8B5CF6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px not-italic relative">
      <p className="font-['Poppins:Bold',sans-serif] relative shrink-0 text-[16px] text-white w-full">Model Services</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[#9ca3af] text-[12px] w-full">High-quality annotation workflows for text, image, audio, video, and multimodal AI systems.</p>
    </div>
  );
}
...
function Regular() {
  return (
    <div className="content-stretch flex flex-col font-['Poppins:Regular',sans-serif] gap-[16px] items-start leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[195px]" data-name="Regular">
      <p className="relative shrink-0 w-full">Crowdsourcing Platform</p>
      <p className="relative shrink-0 w-full">Datasets</p>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0a0a0a] content-stretch flex gap-[72px] items-start justify-center left-1/2 overflow-clip py-[72px] top-[72px] w-[1986px]" data-name="Dropdown">
      <Highlight />
      <Regular />
    </div>
  );
  ...
  return (
    <div className="h-[31.506px] relative shrink-0 w-[47.173px]" data-name="Header">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Poppins:Bold',sans-serif] leading-[31.5px] left-[0.01px] not-italic text-[#e8e7ef] text-[20.25px] top-[-0.25px] tracking-[-0.5063px] whitespace-nowrap">Logo</p>
      </div>
    </div>
  );
}
...
function Link() {
  return (
    <div className="relative shrink-0 w-[300px]" data-name="Link">
...
function TablerIconChevronDown() {
  return (
    <div className="relative size-[16px]" data-name="tabler-icon-chevron-down">
  ...
  return (
    <div className="h-[24px] relative shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] h-full items-center justify-center relative">
        <p className="font-['Poppins:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Products</p>
...
function Navigation() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Navigation">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[36px] items-center justify-center relative w-full">
        <Link1 />
        <Link2 />
        <Link3 />
