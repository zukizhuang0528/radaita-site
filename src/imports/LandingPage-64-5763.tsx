import svgPaths from "./svg-2vxk7hxun8";
...
function Item() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0" data-name="Item">
      <Icon1 />
      <p className="font-['Poppins:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[328px]">About us</p>
    </div>
  );
}
...
function Item1() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Item">
      <Icon2 />
      <p className="font-['Poppins:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[328px]">Teams</p>
    </div>
  );
}
...
function Item2() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Item">
      <Icon3 />
      <p className="font-['Poppins:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[328px]">Contact</p>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#0a0a0a] content-stretch flex items-start left-1/2 overflow-clip pl-[480px] py-[72px] top-[72px] w-[1986px]" data-name="Dropdown">
      <Highlight />
    </div>
  );
}
